...
export class EmpresaEmpleadoController {
  ...
  async find(
    ...
    return this.empresaRepository.empresaempleados(id).find(filter);
  }
  ...
  async create(
    ...
    return this.empresaRepository.empresaempleados(id).create(empleado);
  }
  ...
  async patch(
    ...
    return this.empresaRepository.empresaempleados(id).patch(empleado, where);
  }
  ...
  async delete(
    ...
    return this.empresaRepository.empresaempleados(id).delete(where);
  }
}
