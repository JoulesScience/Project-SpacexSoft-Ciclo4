...
export class NotificacionesController {
  constructor(
    ...
    public notificacionesRepository : NotificacionesRepository,@service(NotificacionService)
    public servicio:NotificacionService
  ) {}
  ...
  async create(
    ...
    this.servicio.enviarSMS(notificaciones.mensajeTexto);
